...
rf2 = RandomForestRegressor(n_estimators=100,  # Number of trees
                           max_depth=7,      # Maximum depth of the trees
                           random_state=42)  # Ensures reproducibilitybst2.fit(X_train, y_train2)
rf2.fit(X_train, y_train2)
y_pred2 = rf2.predict(all_features)
