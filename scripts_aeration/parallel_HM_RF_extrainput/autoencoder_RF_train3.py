...
extrainput=pd.read_csv('data/beluchting/CODs_labmeasurement.csv', index_col=0)
...
for folder_name in all_image_folders:
    ...
    for image_file in images_list_embeddings:
        try:
            ...
            aggregated_features=np.append(aggregated_features, extrainput['CODsprimeff'].loc[folder_name].item())
