...
train_indices_folders=np.arange(30, 87)
test_indices_folders=np.arange(0, 30)
...
plt.plot(kla_predictions.iloc[train_indices_folders], '.-', label='predictions (train)', color='orange')
plt.plot(kla_predictions.iloc[test_indices_folders], '.-', label='predictions (test)', color='red')
