...
train_indices_folders=np.arange(0, 64)
test_indices_folders=np.arange(64, 87)
...
plt.plot(df_kla['kLa'], '.-', label='Measurements', color='blue')
plt.plot(kla_predictions.iloc[train_indices_folders], '.-', label='HM predictions (train)', color='orange')
plt.plot(kla_predictions.iloc[test_indices_folders], '.-', label='HM predictions (test)', color='red')
plt.fill_between(kla_predictions.index[train_indices_folders],
                 kla_lower.iloc[train_indices_folders],
                 kla_upper.iloc[train_indices_folders],
                 color='orange', alpha=0.2, zorder=1)
plt.fill_between(kla_predictions.index[test_indices_folders],
                 kla_lower.iloc[test_indices_folders],
                 kla_upper.iloc[test_indices_folders],
...
plt.plot(Qairres_preds.iloc[train_indices_folders], '.-', label='HM predictions (train)', color='orange')
plt.plot(Qairres_preds.iloc[test_indices_folders], '.-', label='HM predictions (test)', color='red')
plt.fill_between(Qairres_preds.index[train_indices_folders],
                 Qairres_lower.iloc[train_indices_folders],
                 Qairres_upper.iloc[train_indices_folders],
                 color='orange', alpha=0.2, zorder=1)
